            ...
            public static GameObject GetBaseLoader(CreatureGuid cid)
            {
                try
                {
                    ...
                    if (asset != null)
                    {
                        ...
                        if (baseLoader != null)
                        {
                            Debug.Log("Asset Data Plugin: Base Loader '" + baseLoader.GetChild(0).name + "' Found");
                            return baseLoader.GetChild(0).gameObject;
                        }
                        else
                        {
                            Debug.LogWarning("Asset Data Plugin: Could Not Find Base Loader");
                            return null;
                        }
                    }
                    return null;
            ...
            public static GameObject GetAssetLoader(CreatureGuid cid)
            {
                try
                {
                    ...
                    if (asset != null)
                    {
                        ...
                        if (assetLoader != null)
                        {
                            Debug.Log("Asset Data Plugin: Asset Loader '" + assetLoader.GetChild(0).name + "' Found");
                            return assetLoader.GetChild(0).gameObject;
                        }
                        else
                        {
                            Debug.LogWarning("Asset Data Plugin: Could Not Find Asset Loader");
                            return null;
                        }
                    }
                    return null;
